    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Berisi Endpoint API yang dijalankan oleh User <?= $nama_user ?> </p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                        <li class="breadcrumb-item" aria-current="page">Statistik User</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="text-center">Daftar Endpoint API <br> User <?= $nama_user ?></h4>
            </div>
            <br>
            <div class="card-body">
...
function info(id) {
    var url = base + 'Admin/grafik_statistik_user/' + id;
    location.href = url;
}
</script>